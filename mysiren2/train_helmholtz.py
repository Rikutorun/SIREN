...
p.add_argument('--experiment_name', type=str, required=False, default = './experimenttrainfig', 
...
dataset = dataio.SingleHelmholtzSource(sidelength=128, velocity=opt.velocity, source_coords=source_coords)
